...
def get_organization(
    ...
    return {"id": org.id, "name": org.name, "slug": org.slug, "plan": org.plan, "currency": org.currency, "member_count": member_count}
...
def update_organization(
    ...
    db.commit()
    db.refresh(org)
    write_audit(db, member.organization_id, member.user_id, "organization.updated", "organization", org.id)
    return {"id": org.id, "name": org.name, "slug": org.slug, "plan": org.plan, "currency": org.currency}